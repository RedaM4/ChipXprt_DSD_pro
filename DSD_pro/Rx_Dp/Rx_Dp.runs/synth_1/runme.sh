...
HD_PWD='/home/it/chipxprt/DSD_pro/Rx_Dp/Rx_Dp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Rx_DP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Rx_DP.tcl
